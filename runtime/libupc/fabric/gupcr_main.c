/*===-- gupcr_main.c - UPC Runtime Support Library -----------------------===
|*
...
/**
 * @file gupcr_main.c
 * GUPC Libfabric runtime main program.
 */
 ...
 *
 * All hardware/software components of the Libfabric interface
 ...
 *
 * All previously allocated Libfabric resources are released.
 */
void
gupcr_fini (void)
{
