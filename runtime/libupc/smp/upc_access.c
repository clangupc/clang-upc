...
__attribute__ ((__always_inline__))
     static inline void *__upc_access_sptr_to_addr (upc_shared_ptr_t p)
{
...
__getqi2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (u_intQI_t *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__gethi2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (u_intHI_t *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__getsi2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (u_intSI_t *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__getdi2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (u_intDI_t *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__getti2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (u_intTI_t *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__getsf2 (upc_shared_ptr_t p)
{
  ...
  const float *addr;
  GUPCR_OMP_CHECK ();
  addr = (float *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__getdf2 (upc_shared_ptr_t p)
{
  ...
  const double *addr;
  GUPCR_OMP_CHECK ();
  addr = (double *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
...
__gettf2 (upc_shared_ptr_t p)
{
  ...
  GUPCR_OMP_CHECK ();
  addr = (long double *) __upc_access_sptr_to_addr (p);
  result = *addr;
  return result;
}
