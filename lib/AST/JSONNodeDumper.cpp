...
void JSONNodeDumper::VisitUnaryExprOrTypeTraitExpr(
  ...
  case UETT_UPC_LocalSizeOf: JOS.attribute("name", "upc_localsizeof"); break;
  case UETT_UPC_BlockSizeOf: JOS.attribute("name", "upc_blocksizeof"); break;
  case UETT_UPC_ElemSizeOf:  JOS.attribute("name", "upc_elemsizeof"); break;
  }
