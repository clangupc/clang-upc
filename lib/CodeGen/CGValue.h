...
public:
  ...
  static LValue MakeAddr(Address address, QualType type, ASTContext &Context,
    ...
    R.Initialize(type, qs, address.getAlignment(), BaseInfo, TBAAInfo, Loc);
    return R;
  }
  ...
  static LValue MakeBitfield(Address Addr,
    ...
    R.V = Addr.getPointer();
    R.BitFieldInfo = &Info;
    R.Initialize(type, type.getQualifiers(), Addr.getAlignment(), BaseInfo, TBAAInfo, Loc);
    return R;
  }
